document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderMenu(categoryId) {
        ...
        if (categoryId === '130') {
            ...
            // For other categories (Food, Brunch, Cocktails, etc.), render visual card layout
            html = '<div class="full-menu-grid fade-in visible">';
            category.items.forEach(item => {
                const imgSrc = item.image ? item.image : 'assets/images/logo_clean.png';
                html += `
                    <div class="menu-card">
                        <img src="${imgSrc}" alt="${item.name}" class="menu-card-img" onerror="this.src='assets/images/logo_new.png'">
